---
title: "Capítulo 1: El panorama de la IA"
slug: "el-panorama-de-la-ia"
weight: 2
tags:
  - "types-of-ai"
...
draft: false
lang: "es"
book: the-augmented-designer
isIndex: false
translationKey: "the-ai-landscape"
---

## Comprender tus nuevos materiales de diseño

_"Así como un carpintero debe entender la veta de la madera, los puntos de tensión del metal y la elasticidad de la tela, los diseñadores modernos deben entender los distintos tipos de IA—cada uno con propiedades, fortalezas y limitaciones únicas."_
...
_Aplicación en diseño:_ Pruebas A/B en piloto automático. En lugar de probar dos versiones, el ML puede probar miles de microvariaciones y aprender qué resuena con distintos segmentos de usuarios.
...
_Aplicación en diseño:_ Segmentación de usuarios que revela perfiles que nunca supiste que existían. En lugar de asumir "millennials" o "usuarios avanzados", deja que los datos revelen agrupaciones naturales de usuarios basadas en el comportamiento real.
...
_Aplicación en diseño:_ Interfaces dinámicas que se adaptan a los usuarios individuales con el tiempo. Imagina un panel que gradualmente se reorganiza según lo que cada usuario realmente usa, aprendiendo de sus clics y de lo que ignora.

**Dónde profundizar:**

- Google's Machine Learning Crash Course (gratuito, práctico)
...
_Ejemplo del mundo real:_ El Content-Aware Fill de Adobe no sigue reglas sobre qué debería reemplazar a los objetos eliminados. Aprendió de millones de imágenes qué "se ve bien" a los ojos humanos. Desarrolló una intuición para la coherencia visual.

**Dónde profundizar:**

- "Deep Learning" por Ian Goodfellow (la biblia, pero densa)
- La serie de videos sobre redes neuronales de 3Blue1Brown (visual e intuitiva)
- TensorFlow Playground (visualización interactiva)
...
_Aplicación práctica:_ En lugar de categorizar manualmente miles de comentarios de feedback de usuarios, el NLP puede identificar temas, sentimiento y urgencia. Puede distinguir entre "esta función es confusa" (problema de usabilidad) y "no veo por qué usaría esto" (problema de propuesta de valor).
...
- "Speech and Language Processing" por Jurafsky y Martin (exhaustivo)
- El curso de NLP de Hugging Face (práctico y aplicado)
- Las demos de la Natural Language API de Google (verlo en acción)
...
_Aplicaciones revolucionarias:_

- Experiencias de RA que entienden los espacios físicos (IKEA Place)
- Funciones de accesibilidad que describen escenas a usuarios con discapacidad visual
- Búsqueda visual que encuentra productos a partir de fotos ("compra el look")
- Reconocimiento de emociones para pruebas de usuario (detectar confusión o deleite)
...
- PyImageSearch (tutoriales prácticos)
- Las clases CS231n de Stanford (gratis en línea)
...
- Generación de texto (ChatGPT, Claude): Asistencia de escritura, ideación, variaciones de contenido
- Generación de imágenes (Midjourney, DALL-E): Visualización de conceptos, mood boards, creación de recursos
- Generación de código (Copilot, Cursor): Prototipado rápido, creación de componentes
- Generación de video (Runway, Pika): Conceptos de movimiento, contenido promocional
...
_El cambio de habilidades:_ De "empujador de píxeles" a "ingeniero de prompts" a "director creativo." Tu valor no está en producir recursos; está en saber qué pedir, evaluar la calidad y mantener una visión coherente.
...
- Guías de ingeniería de prompts en LearnPrompting.org
- Experimentos diarios en la comunidad de Discord de Midjourney
...
- Instagram usa CV para entender tus fotos, ML para predecir qué te gustará y NLP para moderar comentarios
- Notion usa NLP para entender tus preguntas, IA generativa para escribir contenido y ML para mejorar las sugerencias
- Figma usa CV para la edición de imágenes, ML para el auto-layout e IA generativa para la generación de contenido
...
- El ML necesita datos de entrenamiento de calidad
- El deep learning requiere importantes recursos computacionales
- El NLP tiene dificultades con el sarcasmo y el contexto
- La visión por computadora falla con mala iluminación
- La IA generativa puede alucinar información falsa
...
- El ML te ayuda a entender patrones en el comportamiento de los usuarios
- El deep learning maneja la entrada humana compleja
- El NLP permite que los usuarios se expresen con naturalidad
- La visión por computadora trae lo físico a lo digital
- La IA generativa acelera tu proceso creativo
