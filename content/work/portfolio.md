...
A webapp for fitness coaches to share programs and keep track of their client's progress.

{{% columns %}}
  {{% column %}}
![Cochacha Logbook](/assets/work/cochacha-logbook.png)
  {{% /column %}}
  {{% column %}}
![Cochacha Programs](/assets/work/cochacha-programs.png)
  {{% /column %}}
  {{% column %}}
![Cochacha Analytics](/assets/work/cochacha-analytics.png)
  {{% /column %}}
{{% /columns %}}

### Agentic AI Governance: AIX
...
The first version for AirAsia Super App.
